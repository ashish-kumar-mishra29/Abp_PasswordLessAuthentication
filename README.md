...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p e76ce240-b1ab-4162-8266-c8244c14034e
```

> `e76ce240-b1ab-4162-8266-c8244c14034e` is the password of the certificate, you can change it to any password you want.
